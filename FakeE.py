...
#choose fake e's
data_loose=data_loose[(data_loose['E27Counter']==1)]
WZ_loose=WZ_loose[(WZ_loose['E27Counter']==1)]
...
#loose cut
#data_loose=data_loose[(data_loose['E1IsolationFCTight']==1)]
#WZ_loose=WZ_loose[(WZ_loose['E1IsolationFCTight']==1)]
...
#data_nt=data_loose[(data_loose['E1IDTight']==0)]
#WZ_nt=WZ_loose[(WZ_loose['E1IDTight']==0)]
...
#get fake factor
#fakefactor=np.genfromtxt("root/"+"d0sig/"+"fakefactor.csv", delimiter=',')
#errorfakefactor=np.genfromtxt("root/"+"d0sig/"+"errorfakefactor.csv", delimiter=',')
fakefactor=np.genfromtxt("root/"+"fakefactor.csv", delimiter=',')
print(fakefactor)
#fakefactor=fakefactor*0.5
#print(fakefactor)
...
for i in range(0,len(data_loose)):
    #if (data_loose.iloc[i]['E1IDTight'] == 0):
...
for i in range(0,len(WZ_loose)):
    #if (WZ_loose.iloc[i]['E1IDTight'] == 0):
...
error_str=str(error)
#with open('root/'+'d0sig/'+name+'_FakeE.txt', "w") as file:
with open('root/'+name+'_FakeE.txt', "w") as file:
   lines = [name+'\n', 'total expexted fakes: '+expectedFakes_str+'\n', 'error: '+error_str+'\n']
   file.writelines(lines)
   file.close()

#outputFile=ROOT.TFile('/afs/cern.ch/user/c/cbeier/fakeleptons/root/'+'d0sig/'+name+"_FakeE.root","recreate")
