...
outputFile=ROOT.TFile('/afs/cern.ch/user/c/cbeier/fakeleptons/root_FakeM/'+"Comp_VR.root","recreate")
...
for name in name_list:
    if name=="error":
        ...
        MC_loose_16=pandas.read_csv('/eos/user/c/cbeier/MC16_M/'+name+'_loose.csv')
        MC_loose_16=MC_loose_16[(MC_loose_16['M1Pt']>=27)]
        MC_loose_16=MC_loose_16[(MC_loose_16['VRSelection']==1)]
        MC_loose_17=pandas.read_csv('/eos/user/c/cbeier/MC17_M/'+name+'_loose.csv')
        MC_loose_17=MC_loose_17[(MC_loose_17['M1Pt']>=27)]
        MC_loose_17=MC_loose_17[(MC_loose_17['VRSelection']==1)]
        MC_loose_18=pandas.read_csv('/eos/user/c/cbeier/MC18_M/'+name+'_loose.csv')
        MC_loose_18=MC_loose_18[(MC_loose_18['M1Pt']>=27)]
        ...
        MC_loose=MC_loose[(MC_loose['M27Counter']==1)]

        #pt cut
        #MC_loose=MC_loose[(MC_loose['E1Pt']>=27)]

        #loose cut
        MC_loose=MC_loose[(MC_loose['M1d0sig']<=3)]

        #eta -> abs(eta)   
        MC_loose['M1Eta']=abs(MC_loose['M1Eta'])

        #tight selection
        MC_tight=MC_loose 

        #make tight selection - don't touch! 
        MC_tight=MC_tight[MC_tight['M1QualityTight']==1] #Iso WP
        MC_tight=MC_tight[MC_tight['M1d0sig']<=3] #Iso WP
        MC_tight=MC_tight[MC_tight['M1IsolationFCTight']==1] #Iso WP
    ...
    #xticks_labels=['Unknown','KnownUnknown','Prompt electrons','Charge-flip electrons','Prompt muons','Prompt photon-conversions','Electrons from muons','Tau decays','b-hadron decays','c-hadron decays','Light-flavour decays','Charge-flip muons']
        ...
        plt.figure(1)
        fig,ax=plt.subplots()
        n,bins,patches=ax.hist(MC_tight['M1ID'],bins=bins,align='left',weights=MC_tight['weight']) #weights=MC_tight['weight']
        n_error,bins,patches=ax.hist(MC_tight['M1ID'],bins=bins,align='left',weights=(MC_tight['weight'])**2) #weights=MC_tight['weight']
