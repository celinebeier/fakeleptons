...
#Pt cuts
WZ_loose=WZ_loose[(WZ_loose['FakeEPt']>=27)&(WZ_loose['ZM0Pt']>=27)&(WZ_loose['ZM1Pt']>=27)]
...
hist_WZ_tight,xbins_WZ_tight,ybins_WZ_tight,im_WZ_tight=plt.hist2d(WZ_tight['FakeEPt'], abs(WZ_tight['FakeEEta']), bins=(x_edges,y_edges), weights=WZ_tight['weight'])
hist_WZ_loose,xbins_WZ_loose,ybins_WZ_loose,im_WZ_loose=plt.hist2d(WZ_loose['FakeEPt'], abs(WZ_loose['FakeEEta']), bins=(x_edges,y_edges), weights=WZ_loose['weight'])
print(hist_tight,hist_WZ_tight)
print(hist_loose,hist_WZ_loose)
